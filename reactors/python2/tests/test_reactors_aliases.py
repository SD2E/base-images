...
from reactors.alias import to_unicode
...
#     aliases = r.aliases.get_aliases()
#     assert isinstance(aliases, list)
#     assert isinstance(fake_alias, str) or \
#         isinstance(fake_alias, basestring)
#     assert isinstance(aliases[0], str) or \
#         isinstance(aliases[0], basestring)
#     assert (set(aliases) == set([fake_alias])) or \
#         (set[fake_alias] in set(aliases))
